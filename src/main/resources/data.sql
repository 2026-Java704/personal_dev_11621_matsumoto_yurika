...
-- 項目テーブルデータ
INSERT INTO items(item_name, user_id, genre_id, price,add_date) VALUES('食事代', 1, 2, 1200, '2026/05/01');
INSERT INTO items(item_name, user_id, genre_id, price,add_date) VALUES('給料', 2, 4, 200000, '2026/05/15');